...
class TwoFAMessages
{
    ...
    const NOT_REGISTERED                = "Customer , not registered.Register/Login to configure the plugin.";
    ...
    //TFA FLOW Messages
    const INVALID_PASSCODE                =  'Incorrect Passcode.Please Try Again';
    const OTP_SENT_FAILED                 =  'OTP not sent correctly.Please verify again.';
    const OTP_VALIDATE_FAILED             =   'OTP Enter is Incorrect.Please Try Again';
    ...
    const INVALID_USER_INFO             = 'Error returned from Get User Info Endpoint from the TwoFA Provider';

    const EMAIL_ATTRIBUTE_NOT_RETURNED  = 'Email address not received.';
    //TwoFA Error Messages
